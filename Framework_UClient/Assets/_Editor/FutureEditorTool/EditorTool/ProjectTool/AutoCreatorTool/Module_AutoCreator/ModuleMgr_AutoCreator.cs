...
#Val#
        ...
        private static void CreadModelConst(List<string> nameLst,string AutoCreadPath, bool isHotFix = false)
        {
            ...
            if (isHotFix)
            {
                classStr = classStr.Replace("#namespace#", "ProjectApp.HotFix");
            }
            else
            {
                classStr = classStr.Replace("#namespace#", "ProjectApp");
            }
            File.WriteAllText(AutoCreadPath + @"/ModelConst_AutoCread.cs", classStr, Encoding.UTF8);
            Debug.Log("[ModuleMgr_AutoCread]注册模块常量完成");
        }

        private static void CreadUICtrlConst(List<string> nameLst, string AutoCreadPath, bool isHotFix = false)
        {
            string classStr = ConstClassTemplate.Replace("#CreateTime#", TimerUtil.GetLacalTimeYMD_HHMMSS());
        ...
        private static void CreadCtrlConst(List<string> nameLst, string AutoCreadPath, bool isHotFix = false)
        {
            string classStr = ConstClassTemplate.Replace("#CreateTime#", TimerUtil.GetLacalTimeYMD_HHMMSS());
        ...
        private static void CreadUIConst(List<string> nameLst, string AutoCreadPath, bool isHotFix = false)
        {
            string classStr = ConstClassTemplate.Replace("#CreateTime#", TimerUtil.GetLacalTimeYMD_HHMMSS());
        ...
        private static void CreadModuleMgrRegister(List<string> nameLst, string AutoCreadPath,bool isHotFix=false)
        {
            ...
            Debug.Log("[ModuleMgr_AutoCread]注册模块引用完成");
        }

        private static void CreadUICtrlMsgConst(List<string> nameLst, string AutoCreadPath, bool isHotFix = false)
        {
