...
namespace FutureEditor
{
    ...
    public abstract class MWindowArea
    {
    ...
    public class IconArea : MWindowArea
    {
    ...
    public class EditorToolsWindows : MEditorWindow
    {
        ...
        void DrawIcons()
        {
            iconArea.OnGUI(new Rect(0, 25, window.position.width, window.position.height - 30));
        }
