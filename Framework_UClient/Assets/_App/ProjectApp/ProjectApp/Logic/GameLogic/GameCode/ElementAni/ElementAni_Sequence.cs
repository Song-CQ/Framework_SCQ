...
namespace ProjectApp.GameLogic
{
    ...
    public class MoveElementAni_Sequence : DoTweenSequence, IElementAni
    {
        ...
        protected override void AddTweenToSequence(Sequence seq)
        {
            ...
            seq.Append(DOTween.To(
                ...
                x =>
                {
                    ...
                    Debug.Log(TimerUtil.GetGameTime() + Tar.Data.ToString() + "Ҫ��" + formPot + " to " + toPot + " x " + x + "��ǰ" + Tar.Pos);
                },
                1f,
                Duration));
        }
        ...
        protected override void OnComplete()
        {
            ...
            Tar.Pos = toPot;
            Debug.Log(Tar.Data.ToString() + "�ƶ����" + formPot + " to " + toPot + "��ǰ" + Tar.Pos);
    ...
    public class FallMoveElementAni_Sequence : Base_CurveTween, IElementAni
    {
        ...
        //[Header("��������")]
        private float fallDuration = 0.3f;      // �������ʱ��
        private float fallBounceDuration = 0.7f; // ��������ʱ��
        private float bounceHeight = 0.2f;      // �����߶�
        private Ease fallEase = Ease.OutCubic;  // ���仺��
        private Ease bounceEase = Ease.OutBounce; // ��������
        private Vector3 bouncePoint;

        private float fallEnd;
        private float fallBounceEnd;
        public Vector3 formPot;  // ��ʼλ��
        public Vector3 toPot;    // Ŀ��λ��
    ...
    public class ElasticShakeAnimation_Sequence : DoTweenSequence, IElementAni
    {
        ...
        {
            base.OnStart();
            Debug.Log(Tar.Data.ToString() + "��ʼ����" + TimerUtil.GetGameTime());
        ...
        protected override void AddTweenToSequence(Sequence seq)
        {
            ...
            seq.Append(DOTween.To(
                ...
                progress =>
                {
                    // ���Թ�ʽ��y = e^(-damping * t) * sin(frequency * t)
                    float damping = 5f;
                    ...
                    Debug.Log(Tar.Data.ToString() + "���ڶ���" + TimerUtil.GetGameTime() + Tar.Pos);
                },
                1f,
                shakeDuration
        ...
        {
            base.OnComplete();
            Debug.Log(Tar.Data.ToString() + "��������" + TimerUtil.GetGameTime() + Tar.Pos + "Ŀ��" + originalPos);
            // Tar.Pos = originalPos;
        }
